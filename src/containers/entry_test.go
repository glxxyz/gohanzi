...
func TestEntry_SetGreaterWordLevel(t *testing.T) {
	...
	assertEquals(t, NoHskLevel, sut.GetHskWordLevel(HskVersionA))
	...
	assertEquals(t, HskLevel2, sut.GetHskWordLevel(HskVersionA))
	assert(t, sut.IsHskWordLevel(HskVersionA, HskLevel2), "Version A of this word is level 2")
	assert(t, !sut.IsHskWordLevel(HskVersionA, HskLevel3), "Version A of this word is not level 3")
	assertEquals(t, NoHskLevel, sut.GetHskWordLevel(HskVersionB))
...
func TestEntry_SetTwoWordLevels(t *testing.T) {
	...
	assertEquals(t, HskLevel1, sut.GetHskWordLevel(HskVersionA))
	assertEquals(t, HskLevel2, sut.GetHskWordLevel(HskVersionB))
...
func TestEntry_SetGreaterCharLevel(t *testing.T) {
	sut := containers.Entry{}
	assertEquals(t, NoHskLevel, sut.GetHskCharLevel(HskVersionA))
	...
	assertEquals(t, HskLevel2, sut.GetHskCharLevel(HskVersionA))
	assert(t, sut.IsHskCharLevel(HskVersionA, HskLevel2), "Version A of this char is level 2")
	assert(t, !sut.IsHskCharLevel(HskVersionA, HskLevel3), "Version A of this char is not level 3")
	assertEquals(t, NoHskLevel, sut.GetHskCharLevel(HskVersionB))
...
func TestEntry_SetTwoCharLevels(t *testing.T) {
	...
	assertEquals(t, HskLevel1, sut.GetHskCharLevel(HskVersionA))
	assertEquals(t, HskLevel2, sut.GetHskCharLevel(HskVersionB))
